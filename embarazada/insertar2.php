...
ModificarMenu($_POST['id_db'],$_POST['usuario_db'],$_POST['n_menu'],$_POST['n_descripcion'],$_POST['hoy'],
$_POST['desayuno_lunes'],$_POST['colacion1_lunes'],$_POST['comida_lunes'],$_POST['colacion2_lunes'],$_POST['cena_lunes'],
$_POST['desayuno_martes'],$_POST['colacion1_martes'],$_POST['comida_martes'],$_POST['colacion2_martes'],$_POST['cena_martes'],
$_POST['desayuno_miercoles'],$_POST['colacion1_miercoles'],$_POST['comida_miercoles'],$_POST['colacion2_miercoles'],$_POST['cena_miercoles'],
$_POST['desayuno_jueves'],$_POST['colacion1_jueves'],$_POST['comida_jueves'],$_POST['colacion2_jueves'],$_POST['cena_jueves'],
$_POST['desayuno_viernes'],$_POST['colacion1_viernes'],$_POST['comida_viernes'],$_POST['colacion2_viernes'],$_POST['cena_viernes'],
$_POST['desayuno_sabado'],$_POST['colacion1_sabado'],$_POST['comida_sabado'],$_POST['colacion2_sabado'],$_POST['cena_sabado'],
$_POST['desayuno_domingo'],$_POST['colacion1_domingo'],$_POST['comida_domingo'],$_POST['colacion2_domingo'],$_POST['cena_domingo'],
$_POST['equivalentes']);

function ModificarMenu($id_db, $usuario_db, $n_menu, $n_descripcion, $hoy, 
...
$desayuno_domingo, $colacion1_domingo, $comida_domingo, $colacion2_domingo, $cena_domingo, $valores){
    ...
    $sen = "UPDATE guardar_menus SET id='".$id_db."', n_usuario='".$usuario_db."', nombre_menu='".$n_menu."', descripcion='".$n_descripcion."', fecha='".$hoy."', 
    desayuno_lunes='".$desayuno_lunes."', colacion1_lunes='".$colacion1_lunes."', comida_lunes='".$comida_lunes."', colacion2_lunes='".$colacion2_lunes."', cena_lunes='".$cena_lunes."',
    desayuno_martes='".$desayuno_martes."', colacion1_martes='".$colacion1_martes."', comida_martes='".$comida_martes."', colacion2_martes='".$colacion2_martes."', cena_martes='".$cena_martes."',
    desayuno_miercoles='".$desayuno_miercoles."', colacion1_miercoles='".$colacion1_miercoles."', comida_miercoles='".$comida_miercoles."', colacion2_miercoles='".$colacion2_miercoles."', cena_miercoles='".$cena_miercoles."',
    desayuno_jueves='".$desayuno_jueves."', colacion1_jueves='".$colacion1_jueves."', comida_jueves='".$comida_jueves."', colacion2_jueves='".$colacion2_jueves."', cena_jueves='".$cena_jueves."',
    desayuno_viernes='".$desayuno_viernes."', colacion1_viernes='".$colacion1_viernes."', comida_viernes='".$comida_viernes."', colacion2_viernes='".$colacion2_viernes."', cena_viernes='".$cena_viernes."',
    desayuno_sabado='".$desayuno_sabado."', colacion1_sabado='".$colacion1_sabado."', comida_sabado='".$comida_sabado."', colacion2_sabado='".$colacion2_sabado."', cena_sabado='".$cena_sabado."',
    desayuno_domingo='".$desayuno_domingo."', colacion1_domingo='".$colacion1_domingo."', comida_domingo='".$comida_domingo."', colacion2_domingo='".$colacion2_domingo."', cena_domingo='".$cena_domingo."',
    equivalentes='".$valores."' WHERE id='".$id_db."' ";
