<?php
//Obtenemos los percentiles de peso longitud para niñas
...
percentil_75, percentil_85, percentil_95, percentil_97, percentil_99 FROM pesolongitud_ninas WHERE longitud = '$longitud' LIMIT 1");
