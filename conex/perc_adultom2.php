<?php
//Obtenemos los valores correspondientes de los percentiles Adulto Mayor (Hombres)
$grupo = $_GET['grupo1'];
...
p6_5, p6_10, p6_25, p6_50, p6_75, p6_90, p6_95 FROM adultom_hombre WHERE grupo = '$grupo' LIMIT 1");
