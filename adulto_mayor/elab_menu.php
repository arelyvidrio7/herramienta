...
<html lang="es">
    <head>
        <title>NutriPAES - Adulto Mayor (Crear Menú)</title>
        <meta charset="UTF-8" >
            ...
            <div id="element" class="col-lg-12" style="display: none;"> 
                ...
                <table id="kcal_totales" name="kcal_totales" class="kcal_totales">
                    ...
                    <tbody>
                        <tr>
                            <td>Total Kcal</td>
                            <td><input id="valor_kcal" name="valor_kcal" style="width:150px" placeholder="Kcal asignadas"></td>
                            <td>Prot</td>
                            <td><input id="porc_prot" name="porc_prot" style="width:60px" placeholder="%"></td>
                            <td>Líp</td>
                            <td><input id="porc_lip" name="porc_lip" style="width:60px" placeholder="%"></td>
                            <td>HC</td>
                            <td><input id="porc_carb" name="porc_carb" style="width:60px" placeholder="%"></td>
                        </tr>
                    </tbody>
                </table>
                <br>
                ...
                <th rowspan="2" style="width:140px">Subgrupos</th>
                ...
                <td><input id="eq1" name="eq1" placeholder="Eq" style="width:40px"></td>
                ...
                <td><input id="eq2" name="eq2" placeholder="Eq" style="width:40px"></td>
                ...
                <td>Sin grasa</td>
                <td><input id="eq3" name="eq3" placeholder="Eq" style="width:40px"></td>
                ...
                <tr>
                <td>Con grasa</td>
                <td><input id="eq4" name="eq4" placeholder="Eq" style="width:40px"></td>
                ...
                <td><input id="eq5" name="eq5" placeholder="Eq" style="width:40px"></td>
                ...
                <td><input id="eq6" name="eq6" placeholder="Eq" style="width:40px"></td>
                ...
                <tr>
                <td>Bajo en grasa</td>
                <td><input id="eq7" name="eq7" placeholder="Eq" style="width:40px"></td>
                ...
                <td><input id="eq8" name="eq8" placeholder="Eq" style="width:40px"></td>
                ...
                <tr>
                <td>Alto en grasa</td>
                <td><input id="eq9" name="eq9" placeholder="Eq" style="width:40px"></td>
                ...
                <td>Descremada</td>
                <td><input id="eq10" name="eq10" placeholder="Eq" style="width:40px"></td>
                ...
                <td><input id="eq11" name="eq11" placeholder="Eq" style="width:40px"></td>
                ...
                <tr>
                <td>Entera</td>
                <td><input id="eq12" name="eq12" placeholder="Eq" style="width:40px"></td>
                ...
                <tr>
                <td>Con azúcar</td>
                <td><input id="eq13" name="eq13" placeholder="Eq" style="width:40px"></td>
                ...
                <td>Sin proteína</td>
                <td><input id="eq14" name="eq14" placeholder="Eq" style="width:40px"></td>
                ...
                <tr>
                <td>Con proteína</td>
                <td><input id="eq15" name="eq15" placeholder="Eq" style="width:40px"></td>
                ...
                <td>Sin grasa</td>
                <td><input id="eq16" name="eq16" placeholder="Eq" style="width:40px"></td>
                ...
                <tr>
                <td>Con grasa</td>
                <td><input id="eq17" name="eq17" placeholder="Eq" style="width:40px"></td>
                ...
                <td><input id="eq18" name="eq18" placeholder="Eq" style="width:40px"></td>
                ...
                <td><input id="eq19" name="eq19" placeholder="Eq" style="width:40px"></td>
                ...
                <!-- EXTRA -->
                <tr>
                <td colspan="2"><input id="otro_subgrupo" name="otro_subgrupo" placeholder="Otro subgrupo"></td>
                <td><input id="eq20" name="eq20" placeholder="Eq" style="width:40px"></td>
                <td><input id="energia_eq20" name="energia_eq20" placeholder="--" style="width:40px"></td>
                <td id="energia_r20" style="color:red">0</td>
                <td><input id="proteina_eq20" name="proteina_eq20" placeholder="--" style="width:40px"></td>
                <td id="proteina_r20" style="color:red">0</td>
                <td><input id="lipidos_eq20" name="lipidos_eq20" placeholder="--" style="width:40px"></td>
                <td id="lipidos_r20" style="color:red">0</td>
                <td><input id="carbos_eq20" name="carbos_eq20" placeholder="--" style="width:50px"></td>
                ...
                <td colspan="2">Verduras</td>
                <td id="copiar1"></td>
                <td><input id="desayuno_f1" name="desayuno_f1" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f1" name="colacionm_f1" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f1" name="comida_f1" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f1" name="colacionv_f1" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f1" name="cena_f1" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td colspan="2">Frutas</td>
                <td id="copiar2"></td>
                <td><input id="desayuno_f2" name="desayuno_f2" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f2" name="colacionm_f2" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f2" name="comida_f2" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f2" name="colacionv_f2" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f2" name="cena_f2" style="width:30px" placeholder="--"></td>
                </tr>
                ...
                <td>Sin grasa</td>
                <td id="copiar3"></td>
                <td><input id="desayuno_f3" name="desayuno_f3" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f3" name="colacionm_f3" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f3" name="comida_f3" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f3" name="colacionv_f3" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f3" name="cena_f3" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td>Con grasa</td>
                <td id="copiar4"></td>
                <td><input id="desayuno_f4" name="desayuno_f4" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f4" name="colacionm_f4" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f4" name="comida_f4" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f4" name="colacionv_f4" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f4" name="cena_f4" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td colspan="2">Leguminosas</td>
                <td id="copiar5"></td>
                <td><input id="desayuno_f5" name="desayuno_f5" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f5" name="colacionm_f5" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f5" name="comida_f5" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f5" name="colacionv_f5" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f5" name="cena_f5" style="width:30px" placeholder="--"></td>
                </tr>
                ...
                <td>Muy bajo en grasa</td>
                <td id="copiar6"></td>
                <td><input id="desayuno_f6" name="desayuno_f6" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f6" name="colacionm_f6" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f6" name="comida_f6" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f6" name="colacionv_f6" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f6" name="cena_f6" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td>Bajo en grasa</td>
                <td id="copiar7"></td>
                <td><input id="desayuno_f7" name="desayuno_f7" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f7" name="colacionm_f7" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f7" name="comida_f7" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f7" name="colacionv_f7" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f7" name="cena_f7" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td>Moderado en grasa</td>
                <td id="copiar8"></td>
                <td><input id="desayuno_f8" name="desayuno_f8" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f8" name="colacionm_f8" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f8" name="comida_f8" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f8" name="colacionv_f8" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f8" name="cena_f8" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td>Alto en grasa</td>
                <td id="copiar9"></td>
                <td><input id="desayuno_f9" name="desayuno_f9" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f9" name="colacionm_f9" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f9" name="comida_f9" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f9" name="colacionv_f9" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f9" name="cena_f9" style="width:30px" placeholder="--"></td>
                </tr>
                ...
                <td>Descremada</td>
                <td id="copiar10"></td>
                <td><input id="desayuno_f10" name="desayuno_f10" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f10" name="colacionm_f10" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f10" name="comida_f10" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f10" name="colacionv_f10" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f10" name="cena_f10" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td>Semidescremada</td>
                <td id="copiar11"></td>
                <td><input id="desayuno_f11" name="desayuno_f11" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f11" name="colacionm_f11" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f11" name="comida_f11" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f11" name="colacionv_f11" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f11" name="cena_f11" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td>Entera</td>
                <td id="copiar12"></td>
                <td><input id="desayuno_f12" name="desayuno_f12" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f12" name="colacionm_f12" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f12" name="comida_f12" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f12" name="colacionv_f12" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f12" name="cena_f12" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td>Con azúcar</td>
                <td id="copiar13"></td>
                <td><input id="desayuno_f13" name="desayuno_f13" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f13" name="colacionm_f13" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f13" name="comida_f13" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f13" name="colacionv_f13" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f13" name="cena_f13" style="width:30px" placeholder="--"></td>
                </tr>
                ...
                <td>Sin proteína</td>
                <td id="copiar14"></td>
                <td><input id="desayuno_f14" name="desayuno_f14" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f14" name="colacionm_f14" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f14" name="comida_f14" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f14" name="colacionv_f14" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f14" name="cena_f14" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td>Con proteína</td>
                <td id="copiar15"></td>
                <td><input id="desayuno_f15" name="desayuno_f15" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f15" name="colacionm_f15" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f15" name="comida_f15" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f15" name="colacionv_f15" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f15" name="cena_f15" style="width:30px" placeholder="--"></td>
                </tr>
                ...
                <td>Sin grasa</td>
                <td id="copiar16"></td>
                <td><input id="desayuno_f16" name="desayuno_f16" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f16" name="colacionm_f16" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f16" name="comida_f16" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f16" name="colacionv_f16" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f16" name="cena_f16" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td>Con grasa</td>
                <td id="copiar17"></td>
                <td><input id="desayuno_f17" name="desayuno_f17" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f17" name="colacionm_f17" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f17" name="comida_f17" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f17" name="colacionv_f17" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f17" name="cena_f17" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td colspan="2">Alimentos libres de energía</td>
                <td id="copiar18"></td>
                <td><input id="desayuno_f18" name="desayuno_f18" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f18" name="colacionm_f18" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f18" name="comida_f18" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f18" name="colacionv_f18" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f18" name="cena_f18" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td colspan="2">Bebidas alcohólicas</td>
                <td id="copiar19"></td>
                <td><input id="desayuno_f19" name="desayuno_f19" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f19" name="colacionm_f19" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f19" name="comida_f19" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f19" name="colacionv_f19" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f19" name="cena_f19" style="width:30px" placeholder="--"></td>
                </tr>

                <tr>
                <td id="copiar_subgrupo" colspan="2"></td>
                <td id="copiar20"></td>
                <td><input id="desayuno_f20" name="desayuno_f20" style="width:60px" placeholder="--"></td>
                <td><input id="colacionm_f20" name="colacionm_f20" style="width:30px" placeholder="--"></td>
                <td><input id="comida_f20" name="comida_f20" style="width:60px" placeholder="--"></td>
                <td><input id="colacionv_f20" name="colacionv_f20" style="width:30px" placeholder="--"></td>
                <td><input id="cena_f20" name="cena_f20" style="width:30px" placeholder="--"></td>
                </tr>
                </tbody>
                </table>
                </div>
    ...
    <section class="elaborar_menu" id="elaborar_menu">
        ...
        <input type="hidden" id="equivalentes" name="equivalentes">

        <input type="date" id="hoy" name="hoy" required>
        ...
        <td><input id="n_menu" name="n_menu" placeholder="Nombre de tu menú" style="width:200px" required></td>
        </tr>
        </tbody>
        </table>
        ...
        <tr>
        <td>Descripción: </td>
        <td><input id="n_descripcion" name="n_descripcion" placeholder="Escribe algunas características de tu menú" style="width:500px"></td>
        </tr>
        </tbody>
        </table>
        </div>
        ...
        <table class="tablasemanal" id="tablasemanal">
            ...
            <tbody>
                <tr>
                    ...
                    <td><textarea cols="30" rows="10" id="desayuno_lunes" name="desayuno_lunes" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion1_lunes" name="colacion1_lunes" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="comida_lunes" name="comida_lunes" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion2_lunes" name="colacion2_lunes" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="cena_lunes" name="cena_lunes" class="textarea"></textarea></td>
                </tr>

                <tr>
                    <td><p class="rotar180">Martes</p></td>
                    <td><textarea cols="30" rows="10" id="desayuno_martes" name="desayuno_martes" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion1_martes" name="colacion1_martes" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="comida_martes" name="comida_martes" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion2_martes" name="colacion2_martes" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="cena_martes" name="cena_martes" class="textarea"></textarea></td>
                </tr>

                <tr>
                    <td><p class="rotar180">Miércoles</p></td>
                    <td><textarea cols="30" rows="10" id="desayuno_miercoles" name="desayuno_miercoles" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion1_miercoles" name="colacion1_miercoles" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="comida_miercoles" name="comida_miercoles" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion2_miercoles" name="colacion2_miercoles" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="cena_miercoles" name="cena_miercoles" class="textarea"></textarea></td>
                </tr>

                <tr>
                    <td><p class="rotar180">Jueves</p></td>
                    <td><textarea cols="30" rows="10" id="desayuno_jueves" name="desayuno_jueves" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion1_jueves" name="colacion1_jueves" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="comida_jueves" name="comida_jueves" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion2_jueves" name="colacion2_jueves" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="cena_jueves" name="cena_jueves" class="textarea"></textarea></td>
                </tr>

                <tr>
                    <td><p class="rotar180">Viernes</p></td>
                    <td><textarea cols="30" rows="10" id="desayuno_viernes" name="desayuno_viernes" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion1_viernes" name="colacion1_viernes" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="comida_viernes" name="comida_viernes" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion2_viernes" name="colacion2_viernes" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="cena_viernes" name="cena_viernes" class="textarea"></textarea></td>
                </tr>

                <tr>
                    <td><p class="rotar180">Sábado</p></td>
                    <td><textarea cols="30" rows="10" id="desayuno_sabado" name="desayuno_sabado" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion1_sabado" name="colacion1_sabado" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="comida_sabado" name="comida_sabado" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion2_sabado" name="colacion2_sabado" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="cena_sabado" name="cena_sabado" class="textarea"></textarea></td>
                </tr>

                <tr>
                    <td><p class="rotar180">Domingo</p></td>
                    <td><textarea cols="30" rows="10" id="desayuno_domingo" name="desayuno_domingo" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion1_domingo" name="colacion1_domingo" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="comida_domingo" name="comida_domingo" class="textarea"></textarea></td>
                    <td><textarea cols="15" rows="10" id="colacion2_domingo" name="colacion2_domingo" class="textarea"></textarea></td>
                    <td><textarea cols="30" rows="10" id="cena_domingo" name="cena_domingo" class="textarea"></textarea></td>
                </tr>

            </tbody>
        </table>
        <input type="submit" id="guardar_menu" name="guardar_menu" class="btnDescargar" value="Guardar Menú">
