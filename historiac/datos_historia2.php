...
$sexo = $_POST['resultado_sexo'] ? $_POST['resultado_sexo'] : '';
$fecha_nac = $_POST['fecha_nac'] ? $_POST['fecha_nac'] : '';
$estado_civil = $_POST['resultado_civil'] ? $_POST['resultado_civil'] : '';
$escolaridad = $_POST['resultado_escolaridad'] ? $_POST['resultado_escolaridad'] : '';
...
if(isset($_POST['toma_med'])){
    $toma_med = $_POST['toma_med'];
}else{
    $toma_med = "";
}
...
/* ESTILO DE VIDA */
$actividad = $_POST['resultado_actividad'] ? $_POST['resultado_actividad'] : '';
...
$apetito = $_POST['resultado_apetito'] ? $_POST['resultado_apetito'] : '';
