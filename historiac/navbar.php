          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="pacientes.php">Registro de pacientes</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="../adulto/analisis_clinicos.php">Análisis clínicos</a></li>
                  <li><a class="dropdown-item" href="../adulto/formulas.php">Fórmulas</a></li>
                  <li><a class="dropdown-item" href="../adulto/menus.php">Menús</a></li>
                </ul>
              </li>
